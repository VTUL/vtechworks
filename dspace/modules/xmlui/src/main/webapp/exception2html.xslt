    ...
    <html>
      <head>
        ...
        <style>
          ...
          p.home, p.contact { padding: 10px 30px 10px 15px; margin-left: 15px; font-size: 100%;}
      ...
      <body>
        ...
        <p class="contact">
 		  <a><xsl:attribute name="href"><xsl:value-of select="$contextPath"/>/contact</xsl:attribute><i18n:text>xmlui.error.contact</i18n:text></a>
        </p>
