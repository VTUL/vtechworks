 ...
 * @version $Revision$
 */
public class OMALSDescribeStep extends AbstractProcessingStep
{
    /** log4j logger */
    ...
    /** Constructor */
    public OMALSDescribeStep() throws ServletException
    {
     ...
     * @throws SQLException
     */
    protected void addDefalutData(Item item) throws SQLException
    {
